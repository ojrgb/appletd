...
def main():
    ...
    # -- the callbacks DAT -------------------------------------------------
    callbacks = ensure(master, td.textDAT, "seg_callbacks",
                     master_xy("seg_callbacks"), keep_layout)
    ...
    par_exec = ensure(master, td.parameterexecuteDAT, "seg_par_callbacks",
                     master_xy("seg_par_callbacks"), keep_layout)
    par_exec.text = (
