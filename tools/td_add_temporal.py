#!/usr/bin/env python
"""Add the temporal channels to the appletd COMP. Paste, Run Script. Idempotent.
...
# function in appletd/motion.py, tested with no TouchDesigner present. The only
...
def main():
    ...
    motion_dat.text = MOTION_CALLBACK % {
        "resolver": PACKAGE_ROOT_SOURCE, "floor": SPEEDFLOOR,
