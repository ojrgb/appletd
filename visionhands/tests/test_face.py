...
Ref: visionhands/face.py, DESIGN.md 2.12, 7.
"""
...
from visionhands.face import (
    face_frame_from_observations,
    region_point_counts,
)
from visionhands.face_types import FACE_REGION_NAMES, MAX_FACES, Face
...
class _StubLandmarks:
    ...
    def __init__(self, counts: dict[str, int]) -> None:
        from visionhands.face_types import FACE_REGIONS
...
def test_region_point_counts_is_empty_when_nothing_was_seen() -> None:
    ...
    from visionhands.face_types import blank_face_frame
