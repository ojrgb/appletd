...
def encode_bundle(pairs: Iterable[tuple[str, float]]) -> bytes:
    ...
    syscalls per frame.
    Size: 3480 bytes for our 137 channels (MEASURED), comfortably inside the
          16 KB loopback datagram limit. Watch this if the contract ever grows -
          past ~16 KB the datagram fragments or is dropped outright.
    """
