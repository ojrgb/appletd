...
Ref: appletd/synth_body.py, DESIGN.md 7 (coordinates).
"""
...
from appletd.pose_types import BODY_JOINT_NAMES, MAX_BODIES, Body
from appletd.synth_body import BodyPose, synthetic_body, synthetic_pose_frame
