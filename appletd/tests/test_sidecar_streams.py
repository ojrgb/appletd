...
Ref: DESIGN.md 6.4; appletd/streams.py; appletd/sidecar.py.
"""
...
from appletd.face_types import FaceFrame, blank_face_frame, face_channel_names
from appletd.pose_types import PoseFrame, blank_pose_frame, pose_channel_names
...
from appletd.tests.test_sidecar import decode_bundle
...
def test_the_face_bundle_lands_on_its_own_port_too(
    ...
    (appletd/face_types.py) - and this is what says the plumbing does not."""
    sidecar, _ = _sidecar(ports)
    sidecar.send_once()
...
def test_a_published_face_frame_arrives_with_its_angles_in_degrees(
    ...
    from appletd.face_types import BLANK_FACE, Face
