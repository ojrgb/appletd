...
Ref: appletd/sidecar.py, appletd/maskbuf.py, DESIGN.md 2.19.
"""
...
from appletd.sidecar import Sidecar
from appletd.source import FakeSource
from appletd.streams import REQUEST_SEGMENT, STREAM_HANDS
from appletd.types import blank_frame
...
def test_the_buffer_is_sized_from_the_mask_that_arrived(tmp_path: Path) -> None:
    ...
    from appletd.maskbuf import capacity_for
