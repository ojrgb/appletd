...
`appletd/temporal.py` is an experiment - the question is whether one Script CHOP
...
Ref: appletd/temporal.py, docs/ATTRIBUTES.md (Presence and Motion).
"""
